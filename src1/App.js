    ...
    <ScrollView>
      <View>
        ...
        <View
          ...
          <CustomInput keyboardType="numeric" placeholder="Enter Phone" />

          <Text style={styles.heading}>Country</Text>
          <CustomDropdown placeholder={'Select country'} name="country" />

          <Text style={{fontSize: 35, marginLeft: 20, marginTop: 40}}>
            Academic Details
          </Text>
